...
OutputBaseFilename=stella-2.4.2-win32
Compression=lzma
...
[Files]
Source: "H:\windows\src\stella\stella-2.4.2\stella.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "H:\windows\src\stella\stella-2.4.2\zlib1.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "H:\windows\src\stella\stella-2.4.2\SDL.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "H:\windows\src\stella\stella-2.4.2\docs\*"; DestDir: "{app}\docs"; Flags: ignoreversion recursesubdirs createallsubdirs
